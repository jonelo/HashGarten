...
public class Main extends javax.swing.JFrame implements AlgorithmSelectorDialogInterface {
    ...
    private final static String ACTION_BUTTON_CALCULATE_HASHES = "Calculate File Hash Values";
    private final static String ACTION_BUTTON_VERIFY_HASHES = "Verify File Hash Values";
    ...
    private void initNonGUIcomponents() {
        readProperties();
        initParameters();
        // by default there is no key set, so we need to set an empty byte array
        // in order to satisfy the algorithm details in the help dialog
        if (HashFunctionFactory.getKey() == null) {
...
/*
   ...
   debug("algorithmIdentifier:\n" + parameters.getAlgorithmIdentifier());
    ...
    private void initComponents() {
        ...
        threadsHashingHelpButton2 = new javax.swing.JButton();
        ...
        interactiveUserInputHeaderLabel = new javax.swing.JLabel();
        interactiveInputTypeLabel = new javax.swing.JLabel();
        interactiveInputTypeComboBox = new javax.swing.JComboBox<>();
        interactiveInputLabel = new javax.swing.JLabel();
        interactiveInputTextField = new javax.swing.JPasswordField();
        interactiveOutputTypeLabel = new javax.swing.JLabel();
        interactiveOutputTypeComboBox = new javax.swing.JComboBox<>();
        interactiveOutputTypeComboBox.setRenderer(new EncodingRenderer());
        interactiveOutputTextField = new javax.swing.JTextField();
        interactiveOutputLabel = new javax.swing.JLabel();
        ...
        ignoreHashesCheckBox = new javax.swing.JCheckBox();
        ignoreSizesCheckBox = new javax.swing.JCheckBox();
        ignoreTimestampsCheckBox = new javax.swing.JCheckBox();
        ignoreHelpButton = new javax.swing.JButton();
        ...
        interactiveMenuItem = new javax.swing.JMenuItem();
        ...
        threadsHashingHelpButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/net/jacksum/gui/pix16x16/question.png"))); // NOI18N
        threadsHashingHelpButton2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                threadsHashingHelpButton2ActionPerformed(evt);
            }
        });
        ...
        keyPasswordField.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                keyPasswordFieldKeyReleased(evt);
            }
        });
                            ...
                            .addGroup(integrityStrengthPanelLayout.createSequentialGroup()
                                ...
                                .addGroup(integrityStrengthPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(integrityStrengthPanelLayout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(keyTypeHelpButton))
                                    .addGroup(integrityStrengthPanelLayout.createSequentialGroup()
                                        .addGroup(integrityStrengthPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        interactiveUserInputHeaderLabel.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        interactiveUserInputHeaderLabel.setText("Interactive");
        ...
        interactiveInputTextField.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                interactiveInputTextFieldKeyReleased(evt);
            }
        });

        interactiveOutputTypeLabel.setText("Output Type:");
        ...
        interactivePanelLayout.setHorizontalGroup(
            ...
            .addGroup(interactivePanelLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(interactivePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(interactiveUserInputHeaderLabel)
                    .addGroup(interactivePanelLayout.createSequentialGroup()
                        .addComponent(interactiveOutputTypeLabel)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(interactiveOutputTypeComboBox, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jButton1))
                    .addGroup(interactivePanelLayout.createSequentialGroup()
                        .addGroup(interactivePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(interactiveInputTypeLabel)
                            .addComponent(interactiveInputLabel)
                            .addComponent(interactiveOutputLabel))
                        .addGap(16, 16, 16)
                        .addGroup(interactivePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(interactivePanelLayout.createSequentialGroup()
                                .addComponent(interactiveInputTypeComboBox, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jButton2))
                            .addComponent(interactiveInputTextField)
                            .addComponent(interactiveOutputTextField))))
                .addContainerGap())
        );
        interactivePanelLayout.setVerticalGroup(
            ...
            .addGroup(interactivePanelLayout.createSequentialGroup()
                ...
                .addGroup(interactivePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(interactiveInputTypeLabel)
                    .addComponent(interactiveInputTypeComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jButton2))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(interactivePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(interactiveInputLabel)
                    .addComponent(interactiveInputTextField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(15, 15, 15)
                .addGroup(interactivePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(interactivePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(interactiveOutputTypeComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(interactiveOutputTypeLabel))
                    .addComponent(jButton1))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(interactivePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(interactiveOutputTextField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(interactiveOutputLabel))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        ignoreSizesCheckBox.setText("Sizes");
        ignoreSizesCheckBox.setToolTipText("Ignore the sizes of files?");

        ignoreTimestampsCheckBox.setText("Timestamps");
                ...
                .addGroup(integrityVerificationFilterPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(integrityVerificationFilterPanelLayout.createSequentialGroup()
                        .addGroup(integrityVerificationFilterPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(integrityVerificationFilterPanelLayout.createSequentialGroup()
                                .addComponent(ignoreHashesCheckBox)
                                .addGap(18, 18, 18)
                                .addComponent(ignoreSizesCheckBox)
                                .addGap(18, 18, 18)
                                .addComponent(ignoreTimestampsCheckBox)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(ignoreHelpButton)))
                        .addContainerGap())))
        );
        integrityVerificationFilterPanelLayout.setVerticalGroup(
            ...
            .addGroup(integrityVerificationFilterPanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(integrityVerificationFilterPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, integrityVerificationFilterPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(showOkFilesCheckBox)
                        .addComponent(showFailedFilesCheckBox)
                        .addComponent(showMissingFilesCheckBox)
                        .addComponent(showNewFilesCheckBox))
        ...
        outputFilesInnerPanelLayout.setHorizontalGroup(
            ...
            .addGroup(outputFilesInnerPanelLayout.createSequentialGroup()
                ...
                .addGroup(outputFilesInnerPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(outputFilesInnerPanelLayout.createSequentialGroup()
                        .addGroup(outputFilesInnerPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(standardOutputFileLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 165, Short.MAX_VALUE)
                            .addComponent(standardErrorFileLabel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(outputFilesInnerPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(outputFilesInnerPanelLayout.createSequentialGroup()
        ...
        outputFilesOptionsPanelLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, outputFilesOptionsPanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(outputFilesOptionsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        getContentPane().add(tabbedPane, new java.awt.GridBagConstraints());
        ...
        calcMenuItem.setText("Calculate File Hash Values");
        ...
        verifyMenuItem.setText("Verify File Hash Values");
        ...
        modeMenu.add(interactiveMenuItem);
    ...
    private void customStylePanel2parameters(
        ...
        if (outputStyleComboBox.getSelectedItem().equals("default")) {
            parameters.setFormat(null);
            parameters.setEncoding((Encoding) null);
            parameters.unsetFilesizeWanted();
            parameters.setTimestampFormat(null);            
    ...
    private void parameters2verificationPanel() {
            ...
            ignoreSizesCheckBox.setSelected(parameters.isIgnoreSizes());
            ignoreTimestampsCheckBox.setSelected(parameters.isIgnoreTimestamps());
    ...
    private void verificationPanel2Parameters() throws UserInputError {
        if (operatingMode == OperatingMode.VERIFY) {
            ...
            // ignore these fields if they are present in a check file
            parameters.setIgnoreHashes(ignoreHashesCheckBox.isSelected());
            parameters.setIgnoreSizes(ignoreSizesCheckBox.isSelected());
            parameters.setIgnoreTimestamps(ignoreTimestampsCheckBox.isSelected());
    ...
    private void outputFilesPanel2parameters() {
        // Standard output
    ...
    private void GUI2parameters() throws UserInputError {
        // invisible settings
        ...
        // update the parameter object from the user input that has been done on all the panels
        inputPanel2parameters();
        calculationPanel2parameters();
        verificationPanel2Parameters();
        outputStylePanel2parameters();
        outputFilesPanel2parameters();
    }
    ...
    private void actionButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_actionButtonActionPerformed
        ...
        //try {
        //List<String> px = parameters.toStringArrayList();
        //for (String s : px) {
        //    debug(s);
        //}
    ...
    private enum OperatingMode { CALC, VERIFY, INTERACTIVE, PREFERENCES}
    ...
    private void setOperatingModeInteractive() {
        tabbedPane.removeAll();
        interactivePanel.setVisible(true);
        tabbedPane.insertTab(PANEL_NAME_CALCULATION, null, calculationPanel, null, 0);
    ...
    private void ignoreHelpButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ignoreHelpButtonActionPerformed
        help(true, "Help", "--ignore-hashes", "--ignore-sizes", "--ignore-timestamps");
    }//GEN-LAST:event_ignoreHelpButtonActionPerformed

    char maskChar;
    
    private void keyTypeComboBoxItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_keyTypeComboBoxItemStateChanged
    ...
    private void threadsHashingHelpButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_threadsHashingHelpButton2ActionPerformed
        // TODO add your handling code here:
    ...
    private void keyTypeHelpButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_keyTypeHelpButtonActionPerformed
        help("--key");
    }//GEN-LAST:event_keyTypeHelpButtonActionPerformed

    private void interactiveMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_interactiveMenuItemActionPerformed
    ...
    private void interactiveInputTypeComboBoxItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_interactiveInputTypeComboBoxItemStateChanged
       if (evt.getStateChange() == ItemEvent.SELECTED) {     
            if (evt.getItem().equals("Password")) {
                interactiveInputTextField.setEchoChar(maskChar);
            } else {
                interactiveInputTextField.setEchoChar((char)0);
            }
       }
       interactiveInputTextFieldKeyReleased(null);
    }//GEN-LAST:event_interactiveInputTypeComboBoxItemStateChanged
    ...
    private void interactiveOutputTypeComboBoxItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_interactiveOutputTypeComboBoxItemStateChanged
        interactiveInputTextFieldKeyReleased(null);
    }//GEN-LAST:event_interactiveOutputTypeComboBoxItemStateChanged
    ...
    // converts an encoding map to an arraylist
    public static javax.swing.ComboBoxModel getComboBoxModel(Map<Encoding, String> map) {
        ArrayList<Encoding> data = new ArrayList();        
        for (Map.Entry<Encoding, String> entry : map.entrySet()) {
            data.add(entry.getKey());
        }
        javax.swing.JComboBox cb = new javax.swing.JComboBox(data.toArray(new Encoding[data.size()]));
        return cb.getModel();
    }
    ...
    private javax.swing.JCheckBox ignoreHashesCheckBox;
    private javax.swing.JButton ignoreHelpButton;
    private javax.swing.JCheckBox ignoreSizesCheckBox;
    private javax.swing.JCheckBox ignoreTimestampsCheckBox;
    ...
    private javax.swing.JLabel interactiveInputLabel;
    private javax.swing.JPasswordField interactiveInputTextField;
    private javax.swing.JComboBox<String> interactiveInputTypeComboBox;
    private javax.swing.JLabel interactiveInputTypeLabel;
    private javax.swing.JMenuItem interactiveMenuItem;
    private javax.swing.JLabel interactiveOutputLabel;
    private javax.swing.JTextField interactiveOutputTextField;
    private javax.swing.JComboBox<String> interactiveOutputTypeComboBox;
    private javax.swing.JLabel interactiveOutputTypeLabel;
    private javax.swing.JPanel interactivePanel;
    private javax.swing.JLabel interactiveUserInputHeaderLabel;
    ...
    private javax.swing.JButton threadsHashingHelpButton2;
